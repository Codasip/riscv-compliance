...
@pytest.mark.find_files(path=os.path.join('rv32i', 'M', 'ISA'), pattern='\.S$')
@pytest.mark.architecture(isa=[ISAS.RV32I], extensions=[RiscVExtensions.M])
def test_rv32i_m_isa(file, reference, user, work_dir):
