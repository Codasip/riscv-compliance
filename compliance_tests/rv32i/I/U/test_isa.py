...
@pytest.mark.find_files(path=os.path.join('rv32i', 'I', 'U'), pattern='\.S$')
@pytest.mark.architecture(isa=[ISAS.RV32I], modes =[Modes.USER])
def test_rv32i_i_u(file, reference, user, work_dir):
