...
@pytest.mark.find_files(path=os.path.join('rv32i', 'C', 'U'), pattern='\.S$')
@pytest.mark.architecture(isa=[ISAS.RV32I], extensions=[RiscVExtensions.C], modes =[Modes.USER])
def test_rv32i_c_u(file, reference, user, work_dir):
