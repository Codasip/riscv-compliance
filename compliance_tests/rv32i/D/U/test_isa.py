...
@pytest.mark.find_files(path=os.path.join('rv32i', 'D', 'U'), pattern='\.S$')
@pytest.mark.architecture(isa=[ISAS.RV32I], extensions=[RiscVExtensions.D], modes =[Modes.USER])
def test_rv32i_d_u(file, reference, user, work_dir):
