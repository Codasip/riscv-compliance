...
@pytest.mark.find_files(path=os.path.join('rv32i', 'A', 'U'), pattern='\.S$')
@pytest.mark.architecture(isa=[ISAS.RV32I], extensions=[RiscVExtensions.A], modes =[Modes.USER])
def test_rv32i_a_u(file, reference, user, work_dir):
